                    ...
                    <div class="we-video-info">
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="like" data-postid="<?= $get['posts_id'] ?>"
                                    title="like">
                                    <?php
                                        $getdt = new posts();
                                        $user_id = $_SESSION['id'];
                        ...
                        <form method="post">
                            <div class="img-cmt">
                                <?php
                                    ...
                                    ?>
                                <input class="input" id="binhluan_<?= $get['posts_id'] ?>" type="text" name="contentcmt"
                                    placeholder="Bình luận">
                                <a class="inputs submit-cmt" type="submit" name="submit-cmt"
                                    data-post="<?= $get['posts_id'] ?>" placeholder="Bình luận"> Gửi</a>
                            </div>
                        </form>
                    </div>
                </div>
