            ...
            <div class="user-post<?= $_SESSION['posts_id'] ?>">
                <div class="friend-info">
                    ...
                    <div class="friend-name">
                        <ins><a href="./Controller/index.php?act=useracout&id=<?= $user_post ?>" title=""><?= $name ?></a></ins>
                    ...
                    <div class="dropdown-post">
                        ...
                        <div class="dropdown-content">
                            <a class="delete" data-delete="<?= $item['posts_id'] ?>">Xóa bài viết</a>
                        </div>
                    </div>
                    ...
                    <div class="post-meta">
                        ...
                        <div class="we-video-info">
                            <ul>
                                <!-- like -->
                                <li>
                                    <span class="like" data-postid="<?= $item['posts_id'] ?>" title="like">
                                        <?php
                                        $getdt = new posts();
                                        $user_id = $_SESSION['id'];
                                        ...
                                        if ($like) {
                                            ...
                                            echo '
                                                    <a type="submit" class="likeInput"  name="likeInput" data-postlike="' . $_GET['id_post'] . '">
