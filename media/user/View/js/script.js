jQuery(document).ready(function ($) {
	...
	$('.top-area > .setting-area > li').on("click", function (event) {
	...
	(function ($) {
		...
		function listFilter(searchDir, list) {
			var form = $("<form>").attr({ "class": "filterform", "action": "#" }),
				input = $("<input>").attr({ "class": "filterinput", "type": "text", "placeholder": "Tìm kiếm bạn..." });
...
//page myacount select avatar and cove_img
...
function toggleElements() {
    var element = document.getElementById("form-cover");
        element.style.display = "block"; 
